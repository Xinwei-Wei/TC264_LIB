...
C_SRCS += \
../src/4_McHal/Tricore/Sent/Std/IfxSent.c 

OBJS += \
./src/4_McHal/Tricore/Sent/Std/IfxSent.o 

C_DEPS += \
./src/4_McHal/Tricore/Sent/Std/IfxSent.d 


# Each subdirectory must supply rules for building sources it contributes
src/4_McHal/Tricore/Sent/Std/%.o: ../src/4_McHal/Tricore/Sent/Std/%.c
	@echo 'Building file: $<'
