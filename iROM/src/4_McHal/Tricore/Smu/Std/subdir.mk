...
C_SRCS += \
../src/4_McHal/Tricore/Smu/Std/IfxSmu.c 

OBJS += \
./src/4_McHal/Tricore/Smu/Std/IfxSmu.o 

C_DEPS += \
./src/4_McHal/Tricore/Smu/Std/IfxSmu.d 


# Each subdirectory must supply rules for building sources it contributes
src/4_McHal/Tricore/Smu/Std/%.o: ../src/4_McHal/Tricore/Smu/Std/%.c
	@echo 'Building file: $<'
