...
C_SRCS += \
../src/4_McHal/Tricore/Eth/Std/IfxEth.c 

OBJS += \
./src/4_McHal/Tricore/Eth/Std/IfxEth.o 

C_DEPS += \
./src/4_McHal/Tricore/Eth/Std/IfxEth.d 


# Each subdirectory must supply rules for building sources it contributes
src/4_McHal/Tricore/Eth/Std/%.o: ../src/4_McHal/Tricore/Eth/Std/%.c
	@echo 'Building file: $<'
