...
C_SRCS += \
../src/4_McHal/Tricore/Stm/Std/IfxStm.c 

OBJS += \
./src/4_McHal/Tricore/Stm/Std/IfxStm.o 

C_DEPS += \
./src/4_McHal/Tricore/Stm/Std/IfxStm.d 


# Each subdirectory must supply rules for building sources it contributes
src/4_McHal/Tricore/Stm/Std/%.o: ../src/4_McHal/Tricore/Stm/Std/%.c
	@echo 'Building file: $<'
