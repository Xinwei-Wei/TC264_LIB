...
C_SRCS += \
../src/4_McHal/Tricore/Cpu/Std/IfxCpu.c 

OBJS += \
./src/4_McHal/Tricore/Cpu/Std/IfxCpu.o 

C_DEPS += \
./src/4_McHal/Tricore/Cpu/Std/IfxCpu.d 


# Each subdirectory must supply rules for building sources it contributes
src/4_McHal/Tricore/Cpu/Std/%.o: ../src/4_McHal/Tricore/Cpu/Std/%.c
	@echo 'Building file: $<'
