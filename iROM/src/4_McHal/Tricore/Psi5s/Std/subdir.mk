...
C_SRCS += \
../src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.c 

OBJS += \
./src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.o 

C_DEPS += \
./src/4_McHal/Tricore/Psi5s/Std/IfxPsi5s.d 


# Each subdirectory must supply rules for building sources it contributes
src/4_McHal/Tricore/Psi5s/Std/%.o: ../src/4_McHal/Tricore/Psi5s/Std/%.c
	@echo 'Building file: $<'
