...
C_SRCS += \
../src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.c 

OBJS += \
./src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.o 

C_DEPS += \
./src/4_McHal/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.d 


# Each subdirectory must supply rules for building sources it contributes
src/4_McHal/Tricore/Psi5s/Psi5s/%.o: ../src/4_McHal/Tricore/Psi5s/Psi5s/%.c
	@echo 'Building file: $<'
