...
C_SRCS += \
../src/4_McHal/Tricore/Qspi/Std/IfxQspi.c 

OBJS += \
./src/4_McHal/Tricore/Qspi/Std/IfxQspi.o 

C_DEPS += \
./src/4_McHal/Tricore/Qspi/Std/IfxQspi.d 


# Each subdirectory must supply rules for building sources it contributes
src/4_McHal/Tricore/Qspi/Std/%.o: ../src/4_McHal/Tricore/Qspi/Std/%.c
	@echo 'Building file: $<'
