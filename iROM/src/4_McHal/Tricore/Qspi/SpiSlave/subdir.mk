...
C_SRCS += \
../src/4_McHal/Tricore/Qspi/SpiSlave/IfxQspi_SpiSlave.c 

OBJS += \
./src/4_McHal/Tricore/Qspi/SpiSlave/IfxQspi_SpiSlave.o 

C_DEPS += \
./src/4_McHal/Tricore/Qspi/SpiSlave/IfxQspi_SpiSlave.d 


# Each subdirectory must supply rules for building sources it contributes
src/4_McHal/Tricore/Qspi/SpiSlave/%.o: ../src/4_McHal/Tricore/Qspi/SpiSlave/%.c
	@echo 'Building file: $<'
