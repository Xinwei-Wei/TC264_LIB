...
typedef struct
{
    ...
    unsigned char            useDma;               /**< \brief use Dma for Data transfers */
...
typedef struct
{
    unsigned short parityError : 1;                   /**< \brief [0:0] Parity Error */
    unsigned short configurationError : 1;            /**< \brief [1:1] Configuration Error */
    unsigned short baudrateError : 1;                 /**< \brief [2:2] baudrate Error */
    unsigned short txFifoOverflowError : 1;           /**< \brief [3:3] TxFifo Overflow Error */
    unsigned short txFifoUnderflowError : 1;          /**< \brief [4:4] TxFifo underflow Error */
    unsigned short rxFifoOverflowError : 1;           /**< \brief [5:5] RxFifo Overflow Error */
    unsigned short rxFifoUnderflowError : 1;          /**< \brief [6:6] RxFifo underflow Error */
    unsigned short expectTimeoutError : 1;            /**< \brief [7:7] Expect Timeout Error */
    unsigned short slsiMisplacedInactivation : 1;     /**< \brief [8:8] SLSI misplaced inactivation (slave mode) */
...
typedef struct
{
    ...
    unsigned char                     onTransfer;       /**< \brief set to TRUE during ongoing transfer */
...
typedef struct
{
    ...
    Ifx_QSPI                        *qspi;                             /**< \brief Pointer to QSPI module registers */
    unsigned char                  allowSleepMode;                   /**< \brief Specifies module sleep mode */
    unsigned char                  pauseOnBaudrateSpikeErrors;       /**< \brief Specifies module pause on baudrate or spike errors */
