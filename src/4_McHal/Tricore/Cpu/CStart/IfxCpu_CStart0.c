...
{
    uint32 pcxi;
    unsigned short cpuWdtPassword = IfxScuWdt_getCpuWatchdogPasswordInline(&MODULE_SCU.WDTCPU[0]);
...

    {
        ...
        unsigned short safetyWdtPassword = IfxScuWdt_getSafetyWatchdogPassword();
