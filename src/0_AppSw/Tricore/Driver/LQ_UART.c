...
///////////////////////////////////////匿名上位机//////////////////////////////////////////////
void Test_Send_User(int data1,int data2, int data3,int data4,int data5,int data6,int data7,int data8,int data9,int data10,int data11,int data12,int data13,int data14,int data15)
{
	char testdatatosend[100];    //发送buffer
	int _cnt=0;
    unsigned char i;
    unsigned char sum = 0;
	...
	testdatatosend[_cnt++]=BYTE3(data7);
	testdatatosend[_cnt++]=BYTE2(data7);
	testdatatosend[_cnt++]=BYTE1(data7);
	testdatatosend[_cnt++]=BYTE0(data7);

	testdatatosend[_cnt++]=BYTE3(data8);
	testdatatosend[_cnt++]=BYTE2(data8);
	testdatatosend[_cnt++]=BYTE1(data8);
	testdatatosend[_cnt++]=BYTE0(data8);

	testdatatosend[_cnt++]=BYTE3(data9);
	testdatatosend[_cnt++]=BYTE2(data9);
	testdatatosend[_cnt++]=BYTE1(data9);
	testdatatosend[_cnt++]=BYTE0(data9);

	testdatatosend[_cnt++]=BYTE3(data10);
	testdatatosend[_cnt++]=BYTE2(data10);
	testdatatosend[_cnt++]=BYTE1(data10);
	testdatatosend[_cnt++]=BYTE0(data10);

	testdatatosend[_cnt++]=BYTE3(data11);
	testdatatosend[_cnt++]=BYTE2(data11);
	testdatatosend[_cnt++]=BYTE1(data11);
	testdatatosend[_cnt++]=BYTE0(data11);

	testdatatosend[_cnt++]=BYTE3(data12);
	testdatatosend[_cnt++]=BYTE2(data12);
	testdatatosend[_cnt++]=BYTE1(data12);
	testdatatosend[_cnt++]=BYTE0(data12);

	testdatatosend[_cnt++]=BYTE3(data13);
	testdatatosend[_cnt++]=BYTE2(data13);
	testdatatosend[_cnt++]=BYTE1(data13);
	testdatatosend[_cnt++]=BYTE0(data13);

	testdatatosend[_cnt++]=BYTE3(data14);
	testdatatosend[_cnt++]=BYTE2(data14);
	testdatatosend[_cnt++]=BYTE1(data14);
	testdatatosend[_cnt++]=BYTE0(data14);

	testdatatosend[_cnt++]=BYTE3(data15);
	testdatatosend[_cnt++]=BYTE2(data15);
	testdatatosend[_cnt++]=BYTE1(data15);
	testdatatosend[_cnt++]=BYTE0(data15);
...
//	HAL_UART_Transmit(&HUSART,testdatatosend,_cnt,20);
	UART_PutBuff(UART0, testdatatosend, _cnt);
}
