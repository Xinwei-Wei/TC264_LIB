...
//IIC1
#define SOFT_IIC_SCL1_PIN   P20_14   /*!< P20_14  作为 SCL */
#define SOFT_IIC_SDA1_PIN   P20_11   /*!< P20_11  作为 SDA */
...
uint8 IIC1_WaitAck(void); 		    //IIC等待ACK信号
void IIC1_SendByte(uint8 data_t);   //IIC发送一个字节
uint8 IIC1_ReadByte(uint8 ack);     //IIC读取一个字节
